...
export const chatWithCopilot = onCall(
  {
    timeoutSeconds: 60, // COST CONTROL: 1 minute timeout for AI chat
    memory: '512MiB',
    maxInstances: 3, // COST CONTROL: Max 3 concurrent chat sessions
    cors: true,
  },
  async (request: CallableRequest<ChatData>) => {
