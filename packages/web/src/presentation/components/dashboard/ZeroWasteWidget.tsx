...
const ActionCard = ({
  ...
  return (
    <div
      className={`p-4 rounded-xl border bg-gradient-to-br ${colorMap[suggestion.suggestedAction as keyof typeof colorMap]} backdrop-blur-md relative group overflow-hidden`}
    >
      ...
      <h4 className="font-bold text-lg text-white mb-1 leading-tight">
    ...
    <div className="premium-glass p-1 rounded-2xl relative overflow-hidden group">
      ...
      <div className="p-5 relative z-10 flex flex-col h-full justify-between">
        <div>
          ...
          <h3 className="text-2xl font-black text-white mb-1">{expiringStats.count} Lotes</h3>
          ...
          <div className="bg-[#1a1a1a] border border-white/10 w-full max-w-4xl max-h-[85vh] rounded-2xl shadow-2xl flex flex-col md:flex-row overflow-hidden">
            ...
            <div className="md:w-1/3 bg-surface-dim p-6 flex flex-col justify-center items-center text-center border-r border-white/5 relative overflow-hidden">
              ...
              <p className="text-sm text-slate-400">
                "He analizado tu inventario. Aquí tienes mis 3 mejores jugadas para evitar tirar
                comida hoy."
              </p>
              <button
                ...
                {suggestions.map((suggestion, idx) => (
                  <ActionCard
                    ...
                    onApply={() => {
                      ...
                      alert(
                        `Acción aplicada: ${suggestion.suggestedAction} para ${suggestion.ingredientName} `
                      );
