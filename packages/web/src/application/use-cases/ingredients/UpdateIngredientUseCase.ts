...
import { UpdateIngredientUseCase as CoreUseCase } from '@culinaryos/core/use-cases/inventory/UpdateIngredientUseCase';
...
export class UpdateIngredientUseCase {
  ...
  async execute(id: string, ingredient: Partial<LegacyIngredient>): Promise<void> {
    ...
    if (ingredient.supplierId !== undefined) dto.supplier = ingredient.supplierId;
    ...
    if (ingredient.costPerUnit !== undefined) {
      dto.lastCost = Money.fromCents(ingredient.costPerUnit * 100);
    }
