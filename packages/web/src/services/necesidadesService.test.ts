...
describe('necesidadesService', () => {
  describe('calculateReorderNeeds', () => {
      ...
      const ingredients: Ingredient[] = [
        {
          ...
          reorderPoint: { value: 10 },
          optimalStock: { value: 20 },
          unit: 'kg',
          costPerUnit: 2,
      ...
      const ingredients: Ingredient[] = [
        {
          ...
          name: 'Flour',
          reorderPoint: { value: 10 },
          optimalStock: { value: 50 },
          unit: 'kg',
          batches: [{ currentQuantity: 5 }, { currentQuantity: 2 }], // Total = 7
        } as any,
      ];
      ...
      const ingredients: Ingredient[] = [
        {
          ...
          name: 'Salt',
          stock: 100,
          reorderPoint: { value: 20 },
          optimalStock: { value: 200 },
          batches: [],
        } as any,
      ];
    ...
    it('should select supplier based on strategy (CHEAPEST vs FASTEST)', () => {
      ...
      // Default: Cheapest
      const needsCheap = necesidadesService.calculateReorderNeeds(ingredients, {
      ...
      // Fastest
      const needsFast = necesidadesService.calculateReorderNeeds(ingredients, {
