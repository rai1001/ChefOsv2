...
export const forecastingService = {
     ...
     */
    getFutureInventoryDemand: (state: AppState, windowDays = 14): Record<string, { neededQuantity: number; eventCount: number }> => {
     ...
     */
    getHistoricalConsumption: (state: AppState, windowDays = 30): Record<string, { totalWaste: number; avgDaily: number }> => {
