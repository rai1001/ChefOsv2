...
const IngredientSchema = z.object({
  ...
  yield: z
    .number()
    .min(0, 'El rendimiento debe estar entre 0 y 1 (0-100%)')
    .max(1, 'El rendimiento debe estar entre 0 y 1 (0-100%)')
    .optional(),
...
export const validateIngredient = (ingredient: Partial<Ingredient>) =>
  wrapValidation(IngredientSchema, ingredient);
